  ...
  return (
    <div className="pt-[90px] pb-[97px] bg-almostWhite relative">
      <section className="container px-6 mx-auto  mt-4 md:px-10 md:mt-[33px] xl:px-[165px] xl:mt-[79px]">
        <button
          href=""
          className="paragraph text-black/50 font-medium hover:text-orange"
          onClick={() => navigate(-1)}
        >
          Go Back
        </button>
        ...
        <form
          ...
          className="xl:flex xl:items-start xl:justify-between xl:space-x-[30px]"
        >
          <div className="mt-6 bg-white pt-6 py-[31px] px-6 rounded-[8px] md:p-8 xl:mt-[56px] xl:py-[54px] xl:px-[48px] xl:w-[65%]">
            <h1 className="text-[28px] tracking-[1px] font-bold md:text-[32px] md:leading-[36px] md:tracking-[1.14px]">
              CHECKOUT
            </h1>

            {/* billing details */}
            <div className="">
              <h2 className="menu uppercase text-orange font-bold mt-8 mb-4 md:mt-[41px]">
                Billing details
              </h2>
            ...
            {/* shipping info */}
            <div>
              <h2 className="menu uppercase text-orange font-bold mt-8 mb-4 md:mt-[53px]">
                Shipping info
              </h2>
            ...
            <div className="md:mt-[53px]">
              <h2 className="menu uppercase text-orange font-bold mt-8 mb-4">
                Payment details
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="md:flex md:justify-between md:items-start">
                  ...
                  <div className="mt-[17px] space-y-4 md:mt-0 md:w-1/2">
                    ...
                    {errors.payment && (
                      <p className="errorMsg">{errors.payment.message}</p>
                    )}
                  </div>
                </div>
          ...
          <div className="mt-8 bg-white pt-6 py-[31px] px-6 rounded-[8px] w-full md:p-8  xl:py-[54px] xl:px-[48px] xl:mt-[56px] xl:w-[35%]">
            ...
            <div className="mt-[31px] h-auto overflow-hidden">
              <div
                className={`${
                  cart.length > 3 ? "overflow-y-scroll" : ""
                } max-h-[250px] space-y-6`}
              >
                    ...
                    >
                      <div className="flex items-center">
                        <img
                          ...
                          className="w-[64px] h-[64px] rounded-[8px] object-cover mr-4"
                        />
                        <div>
                          <p className="paragraph font-bold truncate max-w-[120px] md:max-w-full xl:max-w-[100px] 2xl:max-w-full">
                            {product.name}
                          </p>
                          <p className="text-[14px] leading-[25px] font-bold text-black/50">
                            $ {product.price.toLocaleString()}
                          </p>
                        </div>
                      </div>
                      <p className="paragraph font-bold text-black/50">
                        x{product.quantity}
                      </p>
                    </div>
                  );
            ...
            <div className="mt-8 mb-[47px]">
              ...
              <div className="flex items-center justify-between mb-6">
                <p className="paragraph font-medium text-black/50">
                  TAXES (INCLUDED)
                </p>
                <p className="text-[18px] font-bold">
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-[18px] font-bold text-orange">
