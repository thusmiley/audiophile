  ...
  if (context.show.cart) {
    return (
      <>
        {/* overlay */}
        <div
          className="fixed top-[89px] bottom-0 left-0 right-0 bg-black/70 z-10"
        ...
        <div className="fixed top-[114px] left-0 right-0 container px-6 mx-auto sm:flex sm:justify-end md:px-10 xl:px-[165px] z-10">
          <div className="bg-white rounded-[8px] pt-8 pb-[46px] px-7 sm:min-w-[377px]">
            <div className="flex justify-between items-center fadein">
              ...
              {cartNotEmpty && (
                <p
                  className="pragraph text-black/50 underline decoration-black/50 hover:text-orange hover:decoration-orange cursor-pointer"
                  onClick={() => onRemoveAll(cart)}
                >
                  Remove all
                </p>
              )}
            ...
            <div className="overflow-hidden h-full md:h-auto">
                  <div className={`${cart.length > 3 ? 'overflow-y-scroll' : ''} my-[31px] space-y-6 fadein  h-auto max-h-[250px]`}
                    >
                      ...
                      <div className="flex items-center">
                        <div className="w-[64px] h-[64px]">
                          <img
                            ...
                            className="object-contain object-center w-full h-auto rounded-[8px]"
                          />
                        </div>
                        <div className="ml-4 mr-5 sm:mr-[30px]">
                          <h4 className="paragraph font-bold truncate max-w-[76px] md:max-w-[95px]">
                            {product.name}
                          </h4>
            ...
            {cart.length > 0 ? (
              ...
              <p className="paragraph uppercase font-bold text-orange text-center tracking-[1px] mt-[31px] fadein">
                Your cart is empty.
              </p>
            )}
          </div>
