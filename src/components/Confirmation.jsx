        ...
        <div className="container px-6 mx-auto md:px-10 fixed top-[150px] left-0 right-0 z-10">
          <div className="bg-white rounded-[8px] p-8 md:mx-auto md:p-[48px] md:max-w-[620px]">
            ...
            <div className="mt-6 mb-[39px] md:flex md:items-center">
              <div
                className={`bg-lightGrey rounded-t-[8px] p-6 space-y-6 md:rounded-t-[0px] md:w-[55%] md:rounded-tl-[8px] md:rounded-bl-[8px] ${
                  expanded ? "md:h-[300px] overflow-y-scroll" : "md:h-[150px]"
                }`}
              >
                ...
                {cart.length > 1 && (
                  <p
                    className="text-[12px] tracking-[-0.21px] text-black/50 text-center cursor-pointer underline hover:text-orange border-t-[1px] border-black/10 pt-3 mb-3"
              ...
              <div
                className={`bg-black rounded-b-[8px] p-6 flex flex-col justify-center md:h-[150px] md:rounded-b-[0px] md:w-[45%] md:rounded-r-[8px] md:justify-end ${
                  expanded ? "md:h-[300px]" : "md:h-[150px]"
                }`}
              >
